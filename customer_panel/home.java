...
public class home extends HttpServlet
{
 ...
 ResultSet r;
      ...
      try
	  {
       ...
       out.println("</head>  <body>  <header> <br> <br> 	 <h1>LAPTON</h1> <form>                                 <input type='text' placeholder='Search...' required/>                                 <input type='button' value='Search'/> </form> <br> <br>");

        if(s!=null)
		 {
		 String user1=(String)s.getAttribute("username");
		 out.print("		<h3>  Welcome "+user1+"</h3>");
		 }
...
//<a href='#' id='ex3' title='getAttribute() example' onclick='test3(0)">Link 1</a> - <a href="#" title="Link 2 - setAttribute()" onclick="test3(1)">Link 2</a>
      ...
      r=st.executeQuery("select distinct color from product");
		while(r.next())
		{
		  ...
		  // out.print("<li><script language='javascript' type='text/javascript'>var scrt_var2='"+color+"';</script>");
           out.print("<li><a href='products' onclick=\"location.href=this.href+'?key='+'"+color+"'+'&key2=color';return false;\">"+color+"</a></li>");
		 //  out.println(' <li><a href='#'>'+brand+'</a></li>');
		}
    ...
    out.print("<li>");
           out.print("<a href='products' onclick=\"location.href=this.href+'?key=2&key2=ram';return false;\">Up to 2GB</a></li>");
		   
		   out.print("<li>");
           out.print("<a href='products' onclick=\"location.href=this.href+'?key=4&key2=ram';return false;\">Up to 4GB</a></li>");
		   
		   out.print("<li>");
           out.print("<a href='products' onclick=\"location.href=this.href+'?key=8&key2=ram';return false;\">Up to 8GB</a></li>");
		   
		   out.print("<li>");
           out.print("<a href='products' onclick=\"location.href=this.href+'?key=12&key2=ram';return false;\">Up to 12GB</a></li>");
		   
		   out.print("<li>");
           out.print("<a href='products' onclick=\"location.href=this.href+'?key=16&key2=ram';return false;\">Up to 16GB</a></li>");
		   
		   out.print("<li>");
           out.print("<a href='products' onclick=\"location.href=this.href+'?key=17&key2=ram';return false;\">16GB + more</a></li>");
	   ...
	   out.print("<li>");
           out.print("<a href='products' onclick=\"location.href=this.href+'?key=160&key2=hdd';return false;\">Up to 159GB</a></li>");
		   
		    out.print("<li>");
           out.print("<a href='products' onclick=\"location.href=this.href+'?key=250&key2=hdd';return false;\">160GB to 249GB</a></li>");
		   
		    out.print("<li>");
           out.print("<a href='products' onclick=\"location.href=this.href+'?key=500&key2=hdd';return false;\">250GB to 499GB</a></li>");
		   
		    out.print("<li>");
           out.print("<a href='products' onclick=\"location.href=this.href+'?key=501&key2=hdd';return false;\">500GB + more</a></li>");
	 ...
	 // out.print("<li><a href='#'>Up to 159GB</a></li>");
	  ...
	  out.print("<li>");
           out.print("<a href='products' onclick=\"location.href=this.href+'?key=1.5&key2=processor';return false;\">Up to 1.5GHz</a></li>");
	  
	  out.print("<li>");
           out.print("<a href='products' onclick=\"location.href=this.href+'?key=2&key2=processor';return false;\">1.5GHz to 2GHz</a></li>");
		   
		 out.print("<li>");
           out.print("<a href='products' onclick=\"location.href=this.href+'?key=2.5&key2=processor';return false;\">2.1GHz to 2.5GHz</a></li>");

        out.print("<li>");
           out.print("<a href='products' onclick=\"location.href=this.href+'?key=2.6&key2=processor';return false;\">2.5Ghz + more</a></li>");		   
     ...
     out.print("<a href='products' data-toggle='dropdown' class='dropdown-toggle' onclick=\"location.href=this.href+'?key2=offers';return false;\">OFFER<b class='caret'></b></a></li>");
      ...
      out.print("<li>");
           out.print("<a href='products' onclick=\"location.href=this.href+'?key=11&key2=size';return false;\">10 - 10.9</a></li>");
		   
		   out.print("<li>");
           out.print("<a href='products' onclick=\"location.href=this.href+'?key=12&key2=size';return false;\">11 - 11.9</a></li>");
		   
		   out.print("<li>");
           out.print("<a href='products' onclick=\"location.href=this.href+'?key=13&key2=size';return false;\">12 - 12.9</a></li>");
		   
		   out.print("<li>");
           out.print("<a href='products' onclick=\"location.href=this.href+'?key=14&key2=size';return false;\">13 - 13.9</a></li>");

		   out.print("<li>");
           out.print("<a href='products' onclick=\"location.href=this.href+'?key=15&key2=size';return false;\">14 - 14.9</a></li>");
		   
		   out.print("<li>");
           out.print("<a href='products' onclick=\"location.href=this.href+'?key=16&key2=size';return false;\">15 - 15.9</a></li>");
		   
		   out.print("<li>");
           out.print("<a href='products' onclick=\"location.href=this.href+'?key=17&key2=size';return false;\">16 - 16.9</a></li>");
		   
		   out.print("<li>");
           out.print("<a href='products' onclick=\"location.href=this.href+'?key=18&key2=size';return false;\">17 - 17.9</a></li>");
		   
		   out.print("<li>");
           out.print("<a href='products' onclick=\"location.href=this.href+'?key=19&key2=size';return false;\">18 + more</a></li>");
	 ...
	 out.print("<li>");
           out.print("<a href='products' onclick=\"location.href=this.href+'?key=10000&key2=price';return false;\">BELOW 10000</a></li>");
		   
		   out.print("<li>");
           out.print("<a href='products' onclick=\"location.href=this.href+'?key=20000&key2=price';return false;\">10001 - 20000</a></li>");
		   
		   out.print("<li>");
           out.print("<a href='products' onclick=\"location.href=this.href+'?key=30000&key2=price';return false;\">20001 - 30000</a></li>");
		   
		   out.print("<li>");
           out.print("<a href='products' onclick=\"location.href=this.href+'?key=40000&key2=price';return false;\">30001 - 40000</a></li>");
		   
		   out.print("<li>");
           out.print("<a href='products' onclick=\"location.href=this.href+'?key50000&key2=price';return false;\">40001 - 50000</a></li>");
		   
		   out.print("<li>");
           out.print("<a href='products' onclick=\"location.href=this.href+'?key=60000&key2=price';return false;\">50001 - 60000</a></li>");
		   
		   out.print("<li>");
           out.print("<a href='products' onclick=\"location.href=this.href+'?key=70000&key2=price';return false;\">60001 - 70000</a></li>");
		   
		   out.print("<li>");
           out.print("<a href='products' onclick=\"location.href=this.href+'?key=80000&key2=price';return false;\">70001 - 80000</a></li>");
		   
		   out.print("<li>");
           out.print("<a href='products' onclick=\"location.href=this.href+'?key=80001&key2=price';return false;\">80001 + more</a></li>");
      ...
      r=st.executeQuery("Select distinct Brand from PRODUCT");
		while(r.next())
		{
           ...
           //out.println("<a href='products' onclick=\"location.href=this.href+'?key='+scrt_var3+'&key2=brand';return false;\">"+brand+"</a></li>");
		   
		              out.print("<li><a href='products' onclick=\"location.href=this.href+'?key='+'"+brand+"'+'&key2=brand';return false;\">"+brand+"</a></li>");

		 //  out.println(' <li><a href='#'>'+brand+'</a></li>');
		}
		 out.print("                                                </ul>                     </li>                 </ul>                                                                                                                                                                        </div><!-- /.navbar-collapse -->         </div>     </nav> </div> <br> <br> <br> <br> <br>   <ul class='products'> ");
        
		String name,price,link,pid;
		ResultSet rr;
		...
		while(r.next())
		{
		  ...
		  price=r.getString(2);
		  pid=r.getString(3);
		  rr=st2.executeQuery("select * from image where product_id='"+pid+"'");
		  rr.next();
		  link=rr.getString(2);
		 /*out.print("<li>");
         out.print("<a href='#'>");
         ...
         out.print("</a> </li>");*/
		 		 ...
		 		 out.print("<li>");
		 if(s!=null)
		 out.print("<form action='add_to_cart'>");
