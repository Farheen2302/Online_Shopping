...
public class editbrandlist extends HttpServlet
{
...
out.println("<h1>LAPTON</h1> <form>                              <br> <br> <br> </header> <!--HTML for the Drop Down Menus associated with Top Menu Bar--> <!--They should be inserted OUTSIDE any element other than the BODY tag itself--> <!--A good location would be the end of the page (right above '</BODY>')--> <!--Top Drop Down Menu 1 HTML--> <topper> <pre> <p>  				<br>				  <a href='adminhome.html' >ADMIN HOME</a>     <a href='managebrands' >MANAGE BRANDS</a>          <a href='manageusers' >MANAGE USERS</a>     <a href='manageproduct' >MANAGE PRODUCTS</a>     <a href='manageorders' >MANAGE ORDERS</a>    <a href='logsout' class='myButton'>LOGOUT</a> </P>	 </pre> </topper> <div> <nav> <ul> 		  <li><a href='manageorders'>Manage Orders</a></li> <li><a href='manageproduct'>Manage Products</a></li> <li><a href='manageusers'>Manage Users</a></li> </ul> </nav> </div> <p> <pre>");
out.println(" <section> <h><b><pre>                             UPDATE RECORD(Admin) BRAND LIST</h><br><br></pre> </section> <br> <br>    <form method='post' action='update'> <div>  <level> <br> <pre> BRAND NAME:<br><br>");
String  bname = req.getParameter("brandname");
 int quantity = Integer.parseInt(req.getParameter("quantity"));
 
 out.println("<input id='brand' type='text' placeholder="+bname +" name='new brand'/></pre><br><br>  <pre> QUANTITY:<br> <textarea rows='3' cols='37'name='newquantity' />"+ quantity+" </textarea></pre>");


req.setAttribute("oldbrandname",bname);
req.setAttribute("oldquantity",quantity);
out.println("<pre> <input type='button' class='myButton' value='UPDATE' />   </pre>   </level> </div>  </form><br> <br> </body><footer> Copyright © farheenfnilofer@gmail.com <br> mario <br> bushra <br> <br> </footer>  </body> </html>");
