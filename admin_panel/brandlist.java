...
out.println("<h1>LAPTON</h1> <form>                                 <input type='text' placeholder='Search...' required/>                                 <input type='button' value='Search'/> </form> <br> <br> <br> </header> <!--HTML for the Drop Down Menus associated with Top Menu Bar--> <!--They should be inserted OUTSIDE any element other than the BODY tag itself--> <!--A good location would be the end of the page (right above '</BODY>')--> <!--Top Drop Down Menu 1 HTML--> <topper> <pre> <p>  				<br>				  <a href='http://www.w3schools.com/' target='_blank'>ADMIN HOME</a>     <a href='http://www.w3schools.com/' target='_blank'>MANAGE BRANDS</a>     <a href='http://www.w3schools.com/' target='_blank'>MANAGE CATEGORY</a>     <a href='http://www.w3schools.com/' target='_blank'>MANAGE USERS</a>     <a href='http://www.w3schools.com/' target='_blank'>MANAGE PRODUCTS</a>     <a href='http://www.w3schools.com/' target='_blank'>MANAGE ORDERS</a>    <a href='#' class='myButton'>LOGOUT</a> </P>	 </pre> </topper> <div> <nav> <ul> 		 <li><a href='test_time.htm'>Admin Order</a></li> <li><a href='test_time.htm'>Admin Categorie</a></li> <li><a href='test_time.htm'>Admin Products</a></li> <li><a href='test_time.htm'>Manage Users</a></li> </ul> </nav> </div> <p> <pre>          <a href='#' class='myButton'>ADD BRAND</a></pre></p> <table>     <thead>         <tr>             <th>BRAND NAME</th>             <th>DESCRIPTION</th>             <th>EDIT</th>             <th>DELETE</th>         </tr>     </thead>     <tbody>"); 		
	...
	out.println("<tr>             <td>"+bname+"</td>             <td>"+value+"</td>             <td><a href='#'>edit</a></td>             <td><a href='#'>delete</a></td>              </tr>");
	}
